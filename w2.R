...
coeftest(model, vcov.=vcovHC(model)) # тест дл€ коэф b с учетом скорректированной матрицы ковариации
...
ts2
ts3<-zooreg(x,start=as.yearmon("2014-01"),freq=12)#мес€чные показатели
ts3
...
time(data)#инфа по времени распределени€
coredata(data)#сами данные без времени


#дл€ заполнени€ пропусков
#среднее
na.aprox(data)
...
#получение данных
getSymbols(Symbols="AAPL",from="2010-01-01",to="2014-02-03",src="google")#акции apple c гугл /src=yahoo, данные с €ху
head(AAPL)
tail(AAPL)
